...
namespace Inout
{
    public partial class Form6 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            if (radioButton1.Checked) scom.CommandText = "select * from IOT where DATE>='"+sDate1+"' and DATE<='"+sDate2+"' order by DATE,NUMBER";
            else if (radioButton2.Checked) scom.CommandText = "select * from IOT where DATE>='" + sDate1 + "' and DATE<='" + sDate2 + "' order by NUMBER,DATE";
            ...
            while (qur.Read())
            {
                ...
                String[] row0 = { qur[0].ToString(), qur[1].ToString(), Date, tt[0].Substring(0, 5), tt[1].Substring(0, 5), tt[2].Substring(0,5)};
